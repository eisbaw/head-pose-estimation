...
/// Scale factor for image normalization (1/128)
...
/// Default window size for median filter
pub const DEFAULT_MEDIAN_WINDOW: usize = 5;
/// Default window size for Hampel filter
pub const DEFAULT_HAMPEL_WINDOW: usize = 5;

/// Default filter parameters
pub const DEFAULT_EXPONENTIAL_ALPHA: f64 = 0.5;
/// Default cutoff frequency for first-order low-pass filter
pub const DEFAULT_LOW_PASS_CUTOFF: f64 = 0.5;
/// Default cutoff frequency for second-order low-pass filter
pub const DEFAULT_SECOND_ORDER_CUTOFF: f64 = 30.0;
/// Default damping ratio for second-order low-pass filter (critical damping)
pub const DEFAULT_SECOND_ORDER_DAMPING: f64 = 0.707;
/// Default threshold for Hampel filter outlier detection (in standard deviations)
...
/// Maximum alpha value for exponential filter
